...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <form action="{{ route('inventario.planilla') }}" method="POST">
        @csrf
        ...
        <div class="flex justify-end sticky bottom-4 z-10">
            <button type="submit" class="bg-gray-900 hover:bg-black text-white font-bold py-4 px-10 rounded-xl shadow-xl transition-transform transform hover:scale-105 flex items-center gap-2 text-lg">
